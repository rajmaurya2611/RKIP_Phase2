...
import ChatWindow from "../components/Process/ChatWindow";
import { useSendProcessMessageMutation } from "../store/slices/processApiSlice";
import { PlaceholdersAndVanishInput } from "../components/Process/placeholders-and-vanish-input";
import Header from "../components/Process/Header";
...
export default function Process() {
 ...
 const [sendProcessMessage, {isLoading}]= useSendProcessMessageMutation();
